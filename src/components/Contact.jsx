...
const Contact = () => {
      ...
      <div className="flex lg:gap-x-10 pb-10">
        <span className="flex items-center w-fit">
          <button className="bg-transparent h-14 w-14 font-bold rounded-full border-solid shadowbtn">
            <span className="text-2xl flex justify-center text-[#262626]">
              {icon}
            </span>
          </button>
        ...
        <span>
          ...
          <p className="text-[#262626] m-0">{sub_title}</p>
        </span>
      </div>
    );
  };
  ...
  return (
    <main className="mb-5 lg:py-52 py-16" id="contact">
          ...
          <form className="w-full">
            <div className="sm:flex gap-x-8 w-full mb-8">
              <label className="flex flex-col w-full gap-4">
                <p className="pl-12 text-[#262626] font-bold text-sm">YOUR FULL NAME *</p>
                <input type="text" className="rounded-full h-[60px] px-8" />
              </label>
              <label className="flex flex-col w-full gap-4">
                <p className="pl-12 text-[#262626] font-bold text-sm">YOUR EMAIL ADDRESS *</p>
                <input type="email" className="rounded-full h-[60px] px-8" />
              </label>
            </div>
            <label className="flex flex-col w-full gap-4 mb-8">
              <p className="pl-12 text-[#262626] font-bold text-sm">YOUR SUBJECT *</p>
              <input type="text" className="rounded-full h-[60px] px-8" />
            </label>
            <label className="flex flex-col w-full gap-4 mb-8">
              <p className="pl-12 text-[#262626] font-bold text-sm">YOUR MESSAGE *</p>
              <textarea className="rounded-[30px] p-8 h-[140px] resize-none" />
            </label>
